		...
		return [
			...
			[
				[
					...
					'error_details' => 'Incorrect value "0" for "Limit for search and filter results" field: must be between 1 and 999999.'
				]
			],
			// Incorrect Limit for search and filter results.
			[
				[
					...
					'error_title' => 'Page received incorrect data',
					'error_details' => 'Incorrect value "-1" for "Limit for search and filter results" field: must be between 1 and 999999.'
				]
			],
			...
			[
				[
					...
					'error_title' => 'Page received incorrect data',
					'error_details' => 'Incorrect value "0" for "Max count of elements to show inside table cell" field: must be between 1 and 99999.'
				]
			],
			// Incorrect Max count of elements to show inside table cell.
			[
				[
					...
					'error_title' => 'Page received incorrect data',
					'error_details' => 'Incorrect value "-1" for "Max count of elements to show inside table cell" field: must be between 1 and 99999.'
				]
			]
		];
	}
